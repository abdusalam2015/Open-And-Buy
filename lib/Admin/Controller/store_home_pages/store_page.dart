...
import 'package:volc/User/Controller/product/products.dart';
...
import 'package:volc/SharedModels/product/product.dart';
 ...
 class StorePage extends StatefulWidget{
  ...
  StorePage({this.imgPath, this.storeDiscount, this.storeName,this.cont});
  @override
...
class _StorePageState extends State<StorePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(user == null){
     ...
     // print('Userinside stor page: $user');
      ...
      drawer: DrawerWidget(widget.cont),
    ));
    }
  }
