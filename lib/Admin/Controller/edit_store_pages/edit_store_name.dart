...
class EditStoreName extends StatefulWidget {
final BuildContext cont;
final StoreDetail storeDetail;
EditStoreName(this.cont,this.storeDetail);
  @override
  _EditStoreNameState createState() => _EditStoreNameState();
}

class _EditStoreNameState extends State<EditStoreName> {
          ...
          child:  Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  initialValue:widget.storeDetail.name,
