...
import 'package:volc/payment/services/payment_service.dart';
class HomePayment extends StatefulWidget{
  final BuildContext cont;
  HomePayment(this.cont);
  @override
...
class _HomePaymentState extends State<HomePayment> {
    ...
    switch(index){
      case 0:
       payViaNewCard(context);
        ...
        break;
      case 1:
        Navigator.pushNamed(widget.cont, '/existing_cards');
    } 
  }
  ...
  Widget build(BuildContext context) {
    ThemeData theme = Theme.of(widget.cont);
    return Scaffold(
      appBar: AppBar(
