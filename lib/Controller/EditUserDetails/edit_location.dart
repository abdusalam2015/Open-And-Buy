...
class EditUserLocation extends StatefulWidget {
  @override
  _EditUserLocationState createState() => _EditUserLocationState();
}


class _EditUserLocationState extends State<EditUserLocation> {
  ...
  Widget build(BuildContext context) {
    ...
    _txtFormCtrl.text =
        (newAddress == '') ? userNotifier.userDetail.address : newAddress;
    return Scaffold(
        appBar: AppBar(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                        ...
                        decoration: textInputDecoration(value('address'))
                            .copyWith(hintText: value('addressHint')),
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              try {
                                await DatabaseService.updateUserLocation(
                                    lat == '' ? userDetail.latitude : lat,
                                    long == '' ? userDetail.longitude : long,
                                    newAddress == ''
                                        ? userDetail.address
                                        : newAddress,
                                    userDetail.userID);
