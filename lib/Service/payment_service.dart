...
class StripeService{
  ...
  static String secret = 'sk_test_tqj4YM3qqlPC01UB6K4VD7p500MfVZj6i9';
 ...
 StripePayment.setOptions(
    StripeOptions(
      publishableKey: "pk_test_6d69yEr0WIR8SboXvOxFtEDk00LwLonBGS",
      merchantId: "Test",
      androidPayMode: 'test'
      )
    );
  ...
  static Future< StripeTransactionResponse> payViaExistingCard(
    ...
    var response =   await StripePayment.confirmPaymentIntent(
      ...
      if(response.status == 'succeeded'){
        ...
        return new StripeTransactionResponse(
        message: 'Transaction Faild: ${err.toString()}',
        success: false
      );
      }
  }
